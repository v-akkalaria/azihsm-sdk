...
testdata=testdata_sign_oneshot_"$keybits"_"$algorithm".bin
testdata_hash=testdata_sign_oneshot_hash."$keybits"_"$algorithm"_"$dgst"
signature=testdata_sign_oneshot.sig."$keybits"_"$algorithm"_"$dgst"
