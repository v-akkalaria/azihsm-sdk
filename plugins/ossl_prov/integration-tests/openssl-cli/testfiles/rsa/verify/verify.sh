...
maskedkeyfile=./masked_rsa_verify_"$keybits"_"$algorithm"_imported.bin
testdata=testdata_verify_"$keybits"_"$algorithm".bin
signature=testdata_verify.sig."$keybits"_"$algorithm"_"$dgst"
