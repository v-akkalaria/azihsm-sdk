...
//!   `azihsm_fw_hsm_pal_traits::SESSION_HPKE_INFO` ‖ seed ‖ psk_id ‖
//!   session_type.
...
use azihsm_fw_hsm_pal_traits::SESSION_HPKE_EXPORTER_CONTEXT;
use azihsm_fw_hsm_pal_traits::SESSION_HPKE_INFO;
use azihsm_fw_hsm_pal_traits::SESSION_PARAM_KEY_LABEL;
use azihsm_fw_hsm_pal_traits::SESSION_PARAM_KEY_LEN;
use azihsm_fw_hsm_pal_traits::SESSION_PHASE1_LABEL;
use azihsm_fw_hsm_pal_traits::SESSION_PHASE2_LABEL;
...
pub(super) fn derive_mac_tx_key(exported: &[u8]) -> Result<Vec<u8>, DdiError> {
    hkdf_expand_labeled(
        exported,
        azihsm_fw_hsm_pal_traits::SESSION_MAC_TX_LABEL,
        azihsm_fw_hsm_pal_traits::SESSION_MAC_DIR_KEY_LEN,
    )
}
...
pub(super) fn derive_mac_rx_key(exported: &[u8]) -> Result<Vec<u8>, DdiError> {
    hkdf_expand_labeled(
        exported,
        azihsm_fw_hsm_pal_traits::SESSION_MAC_RX_LABEL,
        azihsm_fw_hsm_pal_traits::SESSION_MAC_DIR_KEY_LEN,
    )
}
